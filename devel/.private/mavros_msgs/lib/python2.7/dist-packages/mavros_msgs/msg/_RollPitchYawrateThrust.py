...
"""autogenerated by genpy from mavros_msgs/RollPitchYawrateThrust.msg. Do not edit."""
import codecs
import sys
...
class RollPitchYawrateThrust(genpy.Message):
  _md5sum = "10a56a30857affade0889a3662fc2bc9"
  _type = "mavros_msgs/RollPitchYawrateThrust"
...
float64 z"""
  ...
  _slot_types = ['std_msgs/Header','float64','float64','float64','geometry_msgs/Vector3']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(RollPitchYawrateThrust, self).__init__(*args, **kwds)
      ...
      if self.thrust is None:
        self.thrust = geometry_msgs.msg.Vector3()
    else:
      self.header = std_msgs.msg.Header()
      self.roll = 0.
      self.pitch = 0.
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_6d().pack(_x.roll, _x.pitch, _x.yaw_rate, _x.thrust.x, _x.thrust.y, _x.thrust.z))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.roll, _x.pitch, _x.yaw_rate, _x.thrust.x, _x.thrust.y, _x.thrust.z,) = _get_struct_6d().unpack(str[start:end])
      return self
