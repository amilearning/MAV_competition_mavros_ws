...
(defsystem "mavros_msgs-msg"
  ...
  :components ((:file "_package")
    ...
    (:file "AllocationMatrix" :depends-on ("_package_AllocationMatrix"))
    (:file "_package_AllocationMatrix" :depends-on ("_package"))
    ...
    (:file "AttitudeThrustTarget" :depends-on ("_package_AttitudeThrustTarget"))
    (:file "_package_AttitudeThrustTarget" :depends-on ("_package"))
