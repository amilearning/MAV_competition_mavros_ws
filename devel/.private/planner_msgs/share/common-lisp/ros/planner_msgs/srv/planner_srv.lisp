...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<planner_srv-request>)))
  ...
  "93605f705f3b765dff37a228844e46b2")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'planner_srv-request)))
  "Returns md5sum for a message object of type 'planner_srv-request"
  "93605f705f3b765dff37a228844e46b2")
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<planner_srv-response>)))
  ...
  (cl:format cl:nil "int32 kForward = 0~%int32 kBackward = 1~%int32 kHoming = 2~%# Status of the best path, take one of the above values.~%int32 status~%~%# Return actual bound mode used for planning~%int32 planning_bound_mode~%~%# Return best path.~%geometry_msgs/Pose[] path~%~%~%================================================================================~%MSG: geometry_msgs/Pose~%# A representation of pose in free space, composed of position and orientation. ~%Point position~%Quaternion orientation~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%================================================================================~%MSG: geometry_msgs/Quaternion~%# This represents an orientation in free space in quaternion form.~%~%float64 x~%float64 y~%float64 z~%float64 w~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'planner_srv-response)))
  "Returns full string definition for message of type 'planner_srv-response"
  (cl:format cl:nil "int32 kForward = 0~%int32 kBackward = 1~%int32 kHoming = 2~%# Status of the best path, take one of the above values.~%int32 status~%~%# Return actual bound mode used for planning~%int32 planning_bound_mode~%~%# Return best path.~%geometry_msgs/Pose[] path~%~%~%================================================================================~%MSG: geometry_msgs/Pose~%# A representation of pose in free space, composed of position and orientation. ~%Point position~%Quaternion orientation~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%================================================================================~%MSG: geometry_msgs/Quaternion~%# This represents an orientation in free space in quaternion form.~%~%float64 x~%float64 y~%float64 z~%float64 w~%~%~%"))
